...
For $\Delta S = 1.25$, because we cannot get the exact point of most of stock price from \$4 to \$16 with increamental of $1, the results are based on the rounded stock prices. Therefore, there are kinks on the lines.