% shrink10.m - compare fitted slope with estimated slope
...
omega=3;    % standard deviation of monthly returns (~7% per year)
...
% estimate the noise magnitude from panel data of monthly returns
